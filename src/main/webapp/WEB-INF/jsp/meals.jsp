...
<div class="jumbotron pt-4">
    ...
    <form id="filter">
        ...
        <dl>
            ...
            <dd><input id="startTime" type="time" name="startTime" value="${param.startTime}"></dd>
        </dl>
        <dl>
        ...
        <button class="btn btn-secondary" onclick="clearFilter()">
            <span class="fa"></span>
            <spring:message code="meal.clear-filter"/>
        </button>
    </form>
    <hr>
    ...
    <table class="table table-striped" id="datatable">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}" id="${meal.id}">
                ...
                <td>${meal.calories}</td>
                <td><a href="ui/meals/update"><span class="fa fa-pencil"></span></a></td>
