...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (GenericXmlApplicationContext appCtx = new GenericXmlApplicationContext()) {
            ...
            appCtx.load("spring/spring-app.xml", "spring/inmemory.xml", "spring/spring-db.xml");
            appCtx.refresh();
            System.out.println("Property sources:  " + appCtx.getEnvironment().getPropertySources());
