...
public class MealServiceTest {
    ...
    public void getBetweenInclusive() {
        List<Meal> actual = service.getBetweenInclusive(LocalDate.of(2020, 10, 18),
                LocalDate.of(2020, 10, 19), USER_ID);
        assertMatch(actual, getExpectedBetween());
    }

    @Test
    public void getAll() {
        List<Meal> all = service.getAll(USER_ID);
        assertMatch(all,meal4, meal1, meal2, meal3);
    }
    ...
    public void update() {
        ...
        assertMatch(service.get(MEAL_ID_UPDATE, USER_ID), updated);
    }
